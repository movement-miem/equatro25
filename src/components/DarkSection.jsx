  ...
  const works = [
    {
      ...
      title: '***',
      description:
        'Прислушайся к зову в груди, К маленькой горстке знаков, Разбросанной в том порядке, В каком тó задумало нечто. Попробуй ее найти — Здесь каждый ответ одинаков: Когда ты, товарищ, в упадке — Поверни-ка с попутной на встречку.',
      smell: 'запах росы',
    ...
    },
    {
      ...
      smell: 'свежего ночного воздуха у пресного водоема',
