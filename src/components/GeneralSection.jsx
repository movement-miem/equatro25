  ...
  const works = [
    {
      ...
      smell:
        'постер №1 ассоциируется со свежестью, запахом моря и солнцезащитного крема; постер №2 ассоциируется с прохладой в летний вечер и свежестью леса; постер №3 ассоциируется с хвойным ароматом и запахом старых ёлочных игрушек',
