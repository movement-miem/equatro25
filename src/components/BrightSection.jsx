...
import bright_3_1 from '../assets/pics/bright_3_1.jpg'
...
function BrightSection() {
  const works = [
    ...
    },
    {
      ...
      title: 'Камера',
      description:
        'Площадка, трава по колено, чипсики пока мама не заметила, голуби. Улыбнитесь, вас снимает скрытая камера!',
      smell: 'запах шин',
    ...
    },
    {
      ...
      smell: 'творожная запеканка, мороз, мокрое дерево, летний зной, железо, кислородный коктейль',
